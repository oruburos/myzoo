...
class SimpleGerryEnv(AECEnv):
    ...
    def render(self, mode='human'):
        ...
        import pettingzoo.mpe._mpe_utils.rendering as rendering
        ...
        if self.render_geoms is None:
            ...
            for entity in self.world.entities:
                ...
                if 'agent' in entity.name:
                    ...
                    vertices = self.randomDistrict( entity.state.p_pos)
                    geom = self.viewer.draw_polygon(vertices)
                    geom.set_color(*entity.color[:3], alpha=0.2)
                else:
